...
describe('StatsService', () => {
    describe('calculateMaximum', () => {
        it('should return maximum', () => {
            ...
            const result = statsService.calculateMaximum([10, 5, 50, 1])
    ...
    describe('calculateMean', () => {
        it('should return mean', () => {
            ...
            const result = statsService.calculateMean([10, 5, 50, 1])
    ...
    describe('calculateMedian', () => {
        it('should return median', () => {
            ...
            const result = statsService.calculateMedian([10, 5, 50, 1])
    ...
    describe('calculateMinimum', () => {
        it('should return minimum', () => {
            ...
            const result = statsService.calculateMinimum([10, 5, 50, 1])
    ...
    describe('calculateStandardDeviation', () => {
        it('should return standard deviation', () => {
            ...
            const result = statsService.calculateStandardDeviation([10, 5, 50, 1])
    ...
    describe('recalculateStandardDeviation', () => {
        it('should return standard deviation', () => {
            ...
            const result = statsService.recalculateStandardDeviation(
    ...
    describe('calculateSum', () => {
        it('should return sum', () => {
            ...
            const result = statsService.calculateSum([10, 5, 50, 1])
